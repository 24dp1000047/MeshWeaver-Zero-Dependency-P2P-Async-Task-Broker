"""
gossip.py — Sahil's Gossip Protocol & Load Table.

Restored from main-branch gossip.py (was misplaced at project root).
This module provides:
  - GossipMessageBuilder: builds GOSSIP_RESOURCE_UPDATE messages.
  - BackgroundMonitorLoop: async loop that continuously collects local metrics.
  - GossipManager: manages the peer load table, handles incoming gossip,
    cleans up stale peers, and broadcasts local resource status.
"""
